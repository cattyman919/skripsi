...
\begin{figure}[H]
	          \centering
	          \includegraphics[height=0.25\textheight]{assets/pics/console_app.jpeg} % Sesuaikan height/width jika perlu
	...
	\item \bo{Aplikasi Qt (\code{app\_qt}, \code{app\_qt\_cloud}):} Aplikasi GUI menggunakan Qt Widgets. UI dari \code{src/app\_qt/forms/todo\_auth.ui}.
        ...
        \begin{figure}[H]
	          \centering
	          \includegraphics[height=0.3\textheight]{assets/pics/qt_app.jpeg} % Sesuaikan height/width jika perlu
	...
	\item \bo{Aplikasi Dear ImGui (\code{app\_imgui}, \code{app\_imgui\_cloud}):} Aplikasi GUI \f{immediate mode} menggunakan Dear ImGui, GLFW, OpenGL.
        ...
        \begin{figure}[H]
	          \centering
	          \includegraphics[height=0.5\textheight]{assets/pics/imgui_app.jpeg} % Sesuaikan height/width jika perlu
