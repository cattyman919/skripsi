...
\begin{itemize}
	\item \bo{Perangkat Lunak:}
	      \begin{itemize}
		      ...
		      \item \bo{Kompiler:} Kompiler MSVC akan digunakan untuk mengkompilasi kode sumber.EagleVM
		      \item \bo{Alat Virtualisasi Kode:} EagleVM akan digunakan sebagai alat utama untuk mengimplementasikan virtualisasi kode.
		      ...
		      \item \bo{Pustaka C++:} Pustaka chrono akan digunakan untuk mengukur waktu eksekusi.
	      \end{itemize}
	\item \bo{Perangkat Lunak:}
	      \begin{itemize}
...
\begin{enumerate}
	\item \bo{Pengaturan Lingkungan:} Lingkungan perangkat lunak diatur untuk memastikan bahwa semua alat (Windows 11, MSVC, EagleVM, Ghidra, dan x64dbg) terinstal dan terkonfigurasi dengan benar. Kode sumber aplikasi studi kasus disiapkan untuk kompilasi.
	\item \bo{Kompilasi Aplikasi Asli:} Aplikasi studi kasus dikompilasi tanpa menerapkan teknik obfuscation apa pun menggunakan kompiler MSVC. Hasilnya adalah file executable asli.
...
\subsection{Analisis Data Pengujian Autentikasi}
\begin{itemize}
  \item \bo{Perbandingan Waktu Eksekusi:} Waktu eksekusi rata-rata antara aplikasi asli dan yang di-obfuscate dibandingkan untuk menilai potensi overhead kinerja yang diperkenalkan oleh EagleVM.
