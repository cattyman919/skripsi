...
\begin{figure}[htbp]
	...
	\begin{tikzpicture}[
			scale=0.75, transform shape, % Skala diagram & teks
...
\begin{figure}[H]
	          \centering
	          \includegraphics[height=0.15\textheight]{\Assets/console_app.jpeg} % Sesuaikan height/width jika perlu
	...
	\item \bo{Aplikasi Qt (\code{app\_qt}, \code{app\_qt\_cloud}):} Aplikasi GUI menggunakan Qt Widgets. UI dari \code{src/app\_qt/forms/todo\_auth.ui}.
        ...
        \begin{figure}[H]
	          \centering
	          \includegraphics[height=0.25\textheight]{\Assets/qt_app.jpeg} % Sesuaikan height/width jika perlu
	...
	\item \bo{Aplikasi Dear ImGui (\code{app\_imgui}, \code{app\_imgui\_cloud}):} Aplikasi GUI \f{immediate mode} menggunakan Dear ImGui, GLFW, OpenGL.
        ...
        \begin{figure}[H]
	          \centering
	          \includegraphics[height=0.15\textheight]{\Assets/imgui_app.jpeg} % Sesuaikan height/width jika perlu
...
Fungsi \code{send\_login\_request} bertanggung jawab untuk mengemas kredensial ke dalam format JSON dan mengirimkannya ke server \textit{backend} menggunakan library \code{libcurl}. 
