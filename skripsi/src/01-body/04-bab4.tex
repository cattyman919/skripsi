...
\begin{enumerate}
    ...
    \item \textbf{Penerapan VxLang:}
        \begin{itemize}
            ...
            % ... (setelah penjelasan build intermediate Lilith_Client_vm.exe) ...
    ...
    \end{minted}
    \captionof{listing}{Contoh Perintah Virtualisasi untuk Lilith RAT Client}
...
\end{itemize} % Menutup itemize dari "Penerapan VxLang:"
